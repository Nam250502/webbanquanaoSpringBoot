...
public class OrderController {
    ...
    public String CheckOut(@ModelAttribute("fullname") String fullname, @ModelAttribute("country") String country,
                           ...
                           @RequestParam(value = "payWithVnPay", defaultValue = "false") boolean payWithVnPay,
        ...
        if (payWithVnPay) {
            ...
            return "redirect:/api/payment/create_payment?amount=" + newOrder.getTotal();
        } else if (payWithMomo) {
            session.setAttribute("newOrder", newOrder);
            ...
            telegramBotService.sendNewBshipTourToGroup(newOrder);
